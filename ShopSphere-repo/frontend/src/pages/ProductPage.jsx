...
import { getProductById, addToCart, fetchCart, reviewAPI } from '../services/api'
...
<div key={review.id} style={{border:'1px solid #e5e7eb', borderRadius:8, padding:12}}>
...
<p style={{marginTop:8, marginBottom:0}}>{review.review_text}</p>
