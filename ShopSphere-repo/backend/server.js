...
(async function runMigrations() {
  try {
    ...
    await pool.query(`CREATE TABLE IF NOT EXISTS product_reviews (
    ...
    // Add unique index if not exists for one review per user/product/order

    try {

    await pool.query('CREATE UNIQUE INDEX ux_product_review_order ON product_reviews(user_id, product_id, order_id)');
